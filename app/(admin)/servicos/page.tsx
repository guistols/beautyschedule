    ...
    return (
        <div className="max-w-6xl mx-auto p-6 md:p-10 font-sans transition-colors">
            <div className="space-y-8">
                ...
                {/* Card da Tabela - Ajustado para quebra de linha */}
                        ...
                        <table className="w-full text-left border-collapse table-fixed md:table-auto">
                            <thead>
                                <tr className="bg-slate-50/50 dark:bg-[#1F2636]/50 border-b border-slate-100 dark:border-white/5">
                                    ...
                                    <th className="px-6 py-4 text-[10px] font-mono font-black uppercase tracking-[0.2em] text-slate-400 w-24 text-right">Ações</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                                {servicos.map((servico) => (
                                    <tr key={servico.codigo} className="group hover:bg-slate-50/50 dark:hover:bg-white/[0.02] transition-colors">
                                        <td className="px-6 py-4 text-sm font-mono text-slate-400">
                                            #{servico.codigo}
                                        </td>

                                        {/* Coluna com Quebra de Linha Automática */}
