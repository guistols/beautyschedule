...
"[project]/app/services/servicoService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function salvarServico(servico) {
    var response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/servico/salvar', servico);
    if (response.status !== 200) {
        console.log(response);
    }
}
async function editarServico(servico) {
    var response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/servico/' + servico.id, servico);
    if (response.status !== 200) {}
}
async function buscarListaServico() {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/servico/listar');
    if (response.status === 200) {
...
async function buscarServicoId(id) {
    const servicoResult = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/servico/' + id);
    return servicoResult.data;
}
async function alterarStatusServico(id, novoStatus) {
    var response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/servico/' + id + '/AlterarStatus', novoStatus);
    if (response.status !== 200) {}
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/app/types/servico/servico.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$servico$2f$servico$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/types/servico/servico.ts [app-client] (ecmascript)");
...
function ServicosForm({ servicoExistente }) {
    _s();
    debugger;
    const [servicos, setServicos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(servicoExistente || new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$servico$2f$servico$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Servico"](null, '', 0, 0, "ATIVO"));
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const handleChange = (campo, valor)=>{
        setServicos((prev)=>new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$servico$2f$servico$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Servico"](prev.id, campo === 'descricao' ? valor : prev.descricao, campo === 'tempo' ? Number(valor) : prev.tempo, campo === 'preco' ? Number(valor) : prev.preco, prev.status));
    };
    const handleSalvar = async (formData)=>{
        if (servicoExistente) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$servicoService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editarServico"])(servicos);
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$servicoService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["salvarServico"])(servicos);
        }
...
function EditarServico() {
    ...
    const buscarServico = async ()=>{
        debugger;
        const servicoResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$servicoService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buscarServicoId"])(codigo);
...
//# sourceMappingURL=app_c0b97720._.js.map