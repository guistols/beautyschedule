...
function Servicos() {
    ...
    const carregarServico = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:8080/servico/listar');
    ...
    const handleAlterarStatus = async (servico)=>{
        ...
        try {
            ...
            var response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('http://localhost:8080/servico/' + servico.id + '/AlterarStatus', novoStatus);
...
//# sourceMappingURL=app_%28admin%29_servicos_page_tsx_9d92ca20._.js.map