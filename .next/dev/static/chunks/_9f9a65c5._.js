...
function AuthProvider({ children }) {
    ...
    const login = (usuario, token)=>{
        setUsuario(usuario);
        setToken(token);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].set("usuario", JSON.stringify(usuario), {
            expires: 7
        });
...
_s(AuthProvider, "6RZx5LVxOGEu91Px4RQap+20O0U=", false, function() {
    return [
...
"[project]/app/context/UltAgendaContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class Agenda {
    codAgenda;
    constructor(codAgenda){
        this.codAgenda = codAgenda;
    }
}
/* Fazer o provider, e buscar o ultimo registro do array para registrar o contexto */ const AgendaContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function AgendaProvider({ children }) {
    _s();
    const [codigo, setCodigo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const ultAgenda = (agenda)=>{
        codigo?.push(agenda);
    };
}
_s(AgendaProvider, "BliEc0MlLj0azmHh/adKO7MQjuc=");
_c = AgendaProvider;
var _c;
__turbopack_context__.k.register(_c, "AgendaProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_9f9a65c5._.js.map