...
"[project]/app/(admin)/clientes/components/Alert.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$DraftContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/context/DraftContext.tsx [app-ssr] (ecmascript)");
;
;
;
;
const Alert = ({ setClientes })=>{
    const { draft, temRascunho, limparRascunho } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$DraftContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDraft"])();
    const [visivel, setVisivel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    // Se não tiver rascunho ou o alerta já foi fechado, não renderiza nada
    if (!temRascunho || !visivel) return null;
    const handleContinuar = ()=>{
        if (draft) {
            setClientes((prev)=>new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$mock$2f$cliente$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Cliente"](prev.id, draft.nome || prev.nome, draft.telefone || prev.telefone, draft.cpf || prev.cpf, prev.status));
        }
        setVisivel(false);
    };
    const handleNovo = ()=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$DraftContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/context/DraftContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$clientes$2f$components$2f$Alert$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/clientes/components/Alert.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function ClientesForm({ clienteExistente }) {
    ...
    const [clientes, setClientes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(clienteExistente || new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$mock$2f$cliente$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Cliente"](null, '', '', '', "ATIVO"));
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { draft, salvarProgresso, limparRascunho, temRascunho } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$DraftContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDraft"])();
    ...
    const handleChange = (campo, valor)=>{
        ...
        setClientes((prev)=>new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$mock$2f$cliente$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Cliente"](prev.id, campo === 'nome' ? valor : prev.nome, campo === 'telefone' ? valor : prev.telefone, campo === 'cpf' ? valor : prev.cpf, prev.status));
    ...
    const handleSalvar = async (formData)=>{
        if (clienteExistente) {
            var response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put('http://localhost:8080/cliente/' + clienteExistente.id, clientes);
            if (response.status !== 200) {
                return;
            }
        } else {
            var response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('http://localhost:8080/cliente/salvar', clientes);
            if (response.status !== 200) {
                return;
            }
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$clientes$2f$components$2f$Alert$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Alert"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdf16c4b._.js.map