...
function Clientes() {
    ...
    const handleAlterarStatus = async (cliente)=>{
        ...
        try {
            ...
            var response = await axios.put('http://localhost:8080/cliente/' + cliente.id + '/AlterarStatus', novoStatus);
            if (response.status !== 200) {
                return;
            }
            setClientes([]);
...
//# sourceMappingURL=app_%28admin%29_clientes_page_tsx_65a0c848._.js.map