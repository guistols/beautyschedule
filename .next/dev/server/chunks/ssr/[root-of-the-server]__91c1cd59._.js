module.exports = [
"[project]/app/types/cliente/cliente.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$cliente$2f$cliente$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/types/cliente/cliente.ts [app-ssr] (ecmascript)");
...
function ClientesForm({ clienteExistente }) {
    ...
    const [clientes, setClientes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(clienteExistente || new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$cliente$2f$cliente$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Cliente"](null, '', '', '', "ATIVO"));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (temRascunho && draft && !clientes.nome && !clientes.cpf) {
            setClientes((prev)=>new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$cliente$2f$cliente$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Cliente"](prev.id, draft.nome || prev.nome, draft.telefone || prev.telefone, draft.cpf || prev.cpf, prev.status));
        }
    }, []);
    ...
    const handleChange = (campo, valor)=>{
        ...
        setClientes((prev)=>new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$cliente$2f$cliente$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Cliente"](prev.id, campo === 'nome' ? valor : prev.nome, campo === 'telefone' ? valor : prev.telefone, campo === 'cpf' ? valor : prev.cpf, prev.status));
    ...
    const handleSalvar = async (formData)=>{
        if (clienteExistente) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$clienteService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["editarCliente"])(clientes);
        } else {
            debugger;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$clienteService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["salvarCliente"])(clientes);
        }
        limparRascunho();
...
function EditarCliente() {
    ...
    const buscarCliente = async ()=>{
        const clienteResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$clienteService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buscarClienteId"])(codigo);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__91c1cd59._.js.map