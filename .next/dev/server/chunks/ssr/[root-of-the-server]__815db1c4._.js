...
function Servicos() {
    ...
    const carregarServico = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:8080/servico/listar');
    ...
    const handleAlterarStatus = async (servico)=>{
        ...
        try {
            ...
            var response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put('http://localhost:8080/servico/' + servico.id + '/AlterarStatus', novoStatus);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__815db1c4._.js.map